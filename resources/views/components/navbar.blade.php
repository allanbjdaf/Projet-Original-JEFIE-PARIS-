...
.mob-link:hover,.mob-link:active{
    background:rgba(255,255,255,.07);color:#f5a623;
}
...
.mob-link:hover svg,.mob-link.active-route svg{opacity:1}
.mob-link-arrow{margin-left:auto;opacity:.35;font-size:12px}
...
.mob-acc-head:hover{background:rgba(255,255,255,.07)}
.mob-acc-head svg{
    width:17px;height:17px;
    stroke:currentColor;fill:none;
    stroke-width:1.7;flex-shrink:0;opacity:.7;
}
.mob-acc-chevron{
    margin-left:auto;
    width:14px;height:14px;
    stroke:rgba(255,255,255,.4);fill:none;stroke-width:2;
    transition:transform .25s;flex-shrink:0;
}
.mob-accordion.open .mob-acc-chevron{transform:rotate(180deg)}
.mob-acc-body{
    display:none;background:rgba(0,0,0,.15);
}
...
.mob-acc-link::before{
    ...
    background:rgba(255,255,255,.2);border-radius:50%;flex-shrink:0;
}
.mob-acc-link:hover{color:#f5a623}
.mob-acc-link:hover::before{background:#f5a623}
...
.mob-btn-inscr:hover{opacity:.9}
.mob-btn-inscr svg{width:16px;height:16px;stroke:currentColor;fill:none;stroke-width:2}
.mob-btn-espace{
    display:flex;align-items:center;justify-content:center;gap:8px;
...
.mob-btn-espace:hover{background:rgba(255,255,255,.14)}
.mob-btn-espace svg{width:16px;height:16px;stroke:currentColor;fill:none;stroke-width:2}
...
.mob-action-btn:hover{background:rgba(255,255,255,.12)}
.mob-action-btn svg{width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:1.8}
.mob-agenda-count{
    display:none;
...
/* Recherche mobile */
.mob-search{padding:.75rem 1.5rem;border-bottom:1px solid rgba(255,255,255,.06)}
.mob-search-input{
...
.mob-search-input:focus{border-color:rgba(245,166,35,.5);background:rgba(255,255,255,.12)}
...
@media(max-width:1100px){
    ...
    .nav-links{gap:.85rem}
    .nav-links a,.nav-dropdown-toggle{font-size:11.5px}
    .nav-btn{padding:8px 14px;font-size:11.5px}
...
@media(max-width:768px){
    ...
    .nav-icon-btn.search-toggle{display:none}
...
@media(max-width:400px){
    ...
    font-family:inherit;
     ...
     .nav-dropdown-toggle:hover{color:#f5a623}
...
<nav class="nav">
    ...
    <div class="nav-right">
        ...
        <a href="{{ route('programme.mon-agenda') }}" class="nav-icon-btn agenda-btn" id="agendaNavBtn" title="Mon agenda">
            <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><line x1="8" y1="14" x2="16" y2="14"/></svg>
...
<div class="mobile-overlay" id="mobileOverlay">
    <div class="mob-inner">
        ...
        <div class="mob-actions-row">
            ...
            <a href="{{ route('inscription') }}" class="mob-action-btn" style="background:rgba(245,166,35,.15);border-color:rgba(245,166,35,.3);color:#f5a623">
                <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
                S'inscrire
            </a>
        </div>
        ...
        <div class="mob-accordion" id="mobJefie">
            <div class="mob-acc-head" onclick="toggleMobAcc('mobJefie')">
                ...
                JEFIE 2026
                <svg class="mob-acc-chevron" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
        ...
        <div class="mob-bottom">
            <a href="{{ route('inscription') }}" class="mob-btn-inscr">
                <svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
